In this scenario, you set up two repositories in GitHub:
- app source code
- ops files

You also built images using [buildpacks](https://buildpacks.io), published images to Docker Hub, and deployed and tested the app in Kubernetes.
